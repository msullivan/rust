...
fn lookup_vtables(vcx: &VtableContext,
    ...
    // We do this backwards for Reasons. XXX: document
    // I'm not actually sure that doing this backwards is very principled.
    // It might be better to do something clever.
